...
public class Ejer02Application {
	...
	public static void main(String[] args) {
		...
		System.out.println("Estoy funcionando --> Ejercicio 2 --> Puerto 8080 :D");
	}
...
Luego, puedes encadenar llamadas a los métodos setters generados automáticamente para establecer los valores
...
*/
			...
			// Recuperar el objeto Persona desde la base de datos para mostrarlo por esta consola
